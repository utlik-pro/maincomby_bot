...
-- Generated: 2025-12-29T15:14:16.529358
...
-- ==================== RESET SEQUENCES ====================
SELECT setval('bot_users_id_seq', (SELECT MAX(id) FROM bot_users));
SELECT setval('bot_events_id_seq', (SELECT MAX(id) FROM bot_events));
SELECT setval('bot_registrations_id_seq', (SELECT MAX(id) FROM bot_registrations));
SELECT setval('bot_feedback_id_seq', (SELECT MAX(id) FROM bot_feedback));
SELECT setval('bot_profiles_id_seq', (SELECT MAX(id) FROM bot_profiles));
SELECT setval('bot_questions_id_seq', (SELECT MAX(id) FROM bot_questions));
SELECT setval('bot_security_logs_id_seq', (SELECT MAX(id) FROM bot_security_logs));
SELECT setval('bot_swipes_id_seq', (SELECT MAX(id) FROM bot_swipes));
SELECT setval('bot_matches_id_seq', (SELECT MAX(id) FROM bot_matches));
