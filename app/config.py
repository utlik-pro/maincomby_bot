...
class Settings:
    ...
    check_subscription_channel_id: int
...
def load_settings() -> Settings:
    ...
    check_subscription_channel_id_raw = os.getenv("CHECK_SUBSCRIPTION_CHANNEL_ID")


    check_subscription_channel_id = int(check_subscription_channel_id_raw) if check_subscription_channel_id_raw and check_subscription_channel_id_raw.strip().lstrip("-").isdigit() else 0
    ...
    return Settings(
        ...
        check_subscription_channel_id=check_subscription_channel_id,
