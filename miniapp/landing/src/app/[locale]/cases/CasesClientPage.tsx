...
const casesData: CaseStudy[] = [
    ...
    },
    {
        ...
        challenge: '1000+ поставщиков с разными форматами документов, ручная сверка накладных с заказами, частые ошибки в приёмке',
        challengeEn: '1000+ suppliers with different document formats, manual invoice reconciliation, frequent receiving errors',
        ...
        results: [
            { metric: 'Поставщиков', metricEn: 'Suppliers', value: '1000+' },
